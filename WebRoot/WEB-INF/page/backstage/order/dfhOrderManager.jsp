  	...
  	<tr>
    	...
    	<td valign="top" background="${pageContext.request.contextPath }/images/backstage/content-bg.gif">
    		<table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
     			<tr>
        			<td height="31"><div class="titlebt">待发货订单</div></td>
      			</tr>
    		</table>
    	</td>
    		...
    		<div id="main_content_main">
    			<table id="dfkTable" cellSpacing=0 cellPadding=0>
    				<tr>
    					...
    					<td align="center" width="15%"><span>总金额</span></td>
    					<td align="center" width="15%"><span>用户</span></td>
    					<td align="center" width="15%"><span>支付方式</span></td>
    				...
    				<c:forEach items="${orders}" var="o">
    					<tr onmousemove="this.bgColor='#EEF2FB'" onmouseout="this.bgColor=''">
    						...
    						<td align="center">&nbsp;
    							<c:if test="${o.orderPayment==0}">
    								在线支付
    							</c:if>
    							<c:if test="${o.orderPayment==2}">
    								货到付款
    							</c:if>
    							<c:if test="${o.orderPayment==1}">
    								线下支付
    							</c:if>
    						</td>
    						<td align="center"> 
    							<input type="hidden" value="${o.orderId}"> 
    							<a href="javascript:void(0);" class="fhckOrder">查看</a>&nbsp;|
    							<a href="javascript:void(0);" class="fhOrder">发货</a>&nbsp;
    						</td>
    					</tr>
    				</c:forEach>
    				<tr>
