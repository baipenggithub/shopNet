    	...
    	<div class="emailAuth">
    		<div >
    			...
    			<div id="email_content">
    				<form action="${pageContext.request.contextPath }/email/sendEmail_regist.action" method="POST" id="checkEmailForm">
    					<table border="0" cellpadding="10" >
    						<tr>
    							<td width="20%" align="right"><span>你的电子邮箱:</span></td>
    							<td width="40%"><input type="text" id="email" name="email"></td>
