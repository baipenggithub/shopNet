  	...
  	<tr>
    	...
    	<td valign="top" background="${pageContext.request.contextPath }/images/backstage/content-bg.gif">
    		<table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
     			<tr>
        			<td height="31"><div class="titlebt">已收货订单</div></td>
      			</tr>
    		</table>
    	</td>
     ...
     <div id="main_content">
    		...
    		<div id="main_content_main">
    			<table id="dfkTable" cellSpacing=0 cellPadding=0>
    				<tr>
    					<td align="center" width=18%"><span>订单编号</span></td>
    					<td align="center" width="18%"><span>订单时间</span></td>
    					<td align="center" width="10%"><span>发货处理员</span></td>
    					<td align="center" width="18%"><span>发货处理时间</span></td>
    					<td align="center" width="10%"><span>用户</span></td>
    					<td align="center" width="18%"><span>收货时间</span></td>
    				...
    				<c:forEach items="${orders}" var="o">
    					<tr onmousemove="this.bgColor='#EEF2FB'" onmouseout="this.bgColor=''">
    						...
    						<td align="center">${o.orderOver}&nbsp;</td>
    						<td align="center"> 
